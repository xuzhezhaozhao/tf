...
h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1) +
                     b_conv1)  # shape (?, 28, 28, 32)
h_pool1 = max_pool_2x2(h_conv1)  # shape (?, 14, 14, 32)

# second convolution layer
W_conv2 = weight_variable([5, 5, 32, 64])
b_conv2 = bias_variable([64])
h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) +
                     b_conv2)  # shape (?, 14, 14, 64)
h_pool2 = max_pool_2x2(h_conv2)  # shape (?, 7, 7, 64)
...
h_pool2_flat = tf.reshape(h_pool2, [-1, 7 * 7 * 64])  # shape (?, 7*7*64)
...
y_conv = tf.matmul(h_fc1_drop, W_fc2) + b_fc2  # (?, 10)
